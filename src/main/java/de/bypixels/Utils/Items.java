...
public class Items extends ItemGenerator{
    ...
    public ItemStack RandomDropGUIItem = new ItemGenerator(Material.DIAMOND).setItemName("§fRandom ItemDrop").addLore("§7Drops a Random Block").addLore("§7Every time you break a block!").build();
